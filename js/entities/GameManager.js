    ...
    setBuyText: function(){
         game.data.buytext = new (me.Renderable.extend({
                    ...
                    draw: function(renderer){
                        ...
                        this.font.draw(renderer.getContext(), "W Ability: Eat Your Creep For Health: " + game.data.ability2 + " Cost: " + ((game.data.ability2)*10), this.pos.x, this.pos.y + 200);
                        this.font.draw(renderer.getContext(), "E Ability: Throw Your Spear: " + game.data.ability3 + " Cost: " + ((game.data.ability3)*10), this.pos.x, this.pos.y + 240);
                    }
